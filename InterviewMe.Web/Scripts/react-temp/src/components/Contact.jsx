        ...
        return (
            <div>
                <div className="container shadow-the-back-sm">
                    <div className="row">
                        <div className="col-lg-12 col-12 contact-us">
                    ...
                    <div className="row bg-light mb-4">
                        ...
                        <div className="col-lg-6 col-12">
                            <div style={{ width: "100%" }}><iframe width="100%" height="400px" src="https://www.mapsdirections.info/en/custom-google-maps/map.php?width=100%&height=600&hl=ru&q=Pauley%20Pavilion%2C%20Los%20Angeles%2C%20CA%2090095+(Interview%20Me)&ie=UTF8&t=&z=14&iwloc=B&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0" title='google' className="shadow-the-back-sm"><a href="https://www.mapsdirections.info/en/custom-google-maps/">Create Google Map</a> by <a href="https://www.mapsdirections.info/en/">Measure area on map</a></iframe></div>
                            <div>
